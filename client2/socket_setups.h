...
The goal: Use 'send' and 'recv' methods with the server in order to forward messages to a specified client
*/
...
bool connectToServer(SOCKET& serverSocket, sockaddr_in& serverAddr);
